Cypress.Commands.add("addTrackerAndGeofenceEnterExit", (isResponsive, geofenceName) => {
    ...
    cy.wait(5000);
    isResponsive ? cy.get('[data-testid="bottomsheet-header-close-icon"]').click() :  cy.get('[data-testid="auth-geofence-box-close-button"]').click();
    cy.wait(5000);
...
Cypress.Commands.add("useUnauthSimulation", (isResponsive) => {
	...
	isResponsive ? cy.get('[data-testid="bottomsheet-header-close-icon"]').click() : cy.get('[data-testid="unauth-simulation-back-arrow"]').click();
