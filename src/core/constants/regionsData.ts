...
const regionsData = [
	{ value: "us-east-1", label: "regions__us_east_1.text" },
	{ value: "us-east-2", label: "regions__us_east_2.text" },
	{ value: "us-west-2", label: "regions__us_west_2.text" },
	// { value: "ap-south-1", label: "regions__ap_south_1.text" },
	...
	{ value: "eu-north-1", label: "regions__eu_north_1.text" },
	{ value: "sa-east-1", label: "regions__sa_east_1.text" }
];
